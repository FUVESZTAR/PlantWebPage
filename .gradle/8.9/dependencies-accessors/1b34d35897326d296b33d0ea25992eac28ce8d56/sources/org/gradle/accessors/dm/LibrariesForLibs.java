...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class GoogleLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>driveApi</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getDrive() {
            return create("google.drive");
        }
    ...
    public static class GoogleHttpClientLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public GoogleHttpClientLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>client</b> with <b>com.google.http-client:google-http-client-android</b> coordinates and
         * with version reference <b>httpClient</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("google.http.client");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>driveApi</b> with value <b>v3-rev20240914-2.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getDriveApi() { return getVersion("driveApi"); }
        ...
        /**
         * Version alias <b>httpClient</b> with value <b>1.44.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
